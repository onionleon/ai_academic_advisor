...
@app.route('/major/<string:major_name>', methods=['GET'])
def get_major_description(major_name):
...
def populate_majors():
    majors_to_add = [
        ...
        {"major_name": "mfin","description": "Offered jointly by the Department of Pure Mathematics and the Department of Statistics and Actuarial Science, Mathematical Finance is designed for students with elite mathematical abilities who wish to pursue finance combined with pure mathematics. * * Waterloo Mathematical Finance graduates often pursue careers in investment banking, financial analysis, and more. They typically work in financial institutions, investment companies, and more. * * Jobs that students pursue after graduation include: * * • Investment Analyst * * • Quantitative Portfolio Manager * • Risk Modeling Analyst"},
        {"major_name": "mopt","description": "You'll start with a solid foundation in math, including combinatorics, linear optimization, modelling, scheduling, forecasting, decision theory, and computer simulation. On top of that, you’ll add courses in economics, business, and management science, in addition to the ability to gain paid work experience through co-op. * * Waterloo Mathematical Optimization graduates commonly pursue careers in software development, business analysis, and operations. They often work in financial institutions, consulting companies, universities, and more. * * Jobs that students pursue after graduation include: * * • Business Analyst * • Software Developer * • Health Information Analyst"},
        {"major_name": "mphys","description": "In Mathematical Physics, you’ll combine theoretical physics with high-level math courses in differential equations, vector calculus, and applied mathematics. You’ll also get plenty of chances to apply that learning with hands-on labs in mechanics, electricity and magnetism, computer programming, optics, and more. * * Mathematical Physics graduates commonly pursue careers in industry analysis and modelling, software development and theoretical physics research with nuclear power companies, tech companies, engineering firms, and more. Many graduates also pursue specialized master's and PhD studies. * * Jobs that students pursue after graduation include: * * • Research Assistant * • Lecturer * • Machine Learning Engineer"},
        {"major_name": "pmath","description": "Waterloo Pure Mathematics graduates typically pursue careers in information technology, data analysis, quantitative analysis, and more. They often work for financial institutions, consulting firms, investment firms, and technology companies. * * Pure Mathematics will provide you with problem-solving skills that can be applied in industry, business, government, or graduate school. * * Jobs that students pursue after graduation include: * * • Quantitative Analyst * • Threat Intelligence Analyst * • Software Engineer"},
        {"major_name": "stat","description": "In today’s data-driven world, statisticians are in high demand. Get the skills you need to help businesses market new products, researchers evaluate medical treatments, governments shape effective public policy, and more. * * Waterloo Statistics graduates often pursue careers in business, market, and data analysis, investment advisory, and more. They commonly work for telecommunications companies, financial institutions, and software companies. * * Jobs that students pursue after graduation include: * * • Data Engineer * • Market Analyst * • Business Intelligence"},
    ]
